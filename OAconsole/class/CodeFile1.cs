...
namespace QuickType_configlist
{
    using System;
    ...
    public partial class List
    {
        ...
        public ProductTypePath ProductTypePath { get; set; }
    ...
    public enum ProductName { R5210G11Ib521 };

    public enum ProductPlatformId { Ib521 };
    ...
    internal class ProductNameConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            if (value == ProductName.R5210G11Ib521)
            {
    ...
    internal class ProductPlatformIdConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            if (value == ProductPlatformId.Ib521)
            {
